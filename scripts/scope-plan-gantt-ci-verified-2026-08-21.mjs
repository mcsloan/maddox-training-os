...
replaceOnce(
  ...
  "| In progress | QA-SYSTEM-001, QA-AUTOMATION-OWNERSHIP-001, DEF-PLAN-GANTT-14WEEK-SPAN-001, DEF-QA-CODEX-RUNNER-001, KPI-ROADMAP-001,",
  "P1 in-progress index",
);
replaceOnce(
  "| Completed |",
  "| Completed | QA-PLAYWRIGHT-SMOKE-001,",
  "first completed index row",
);
