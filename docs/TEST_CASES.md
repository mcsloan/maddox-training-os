...
| TCG-008 Completed-session/read-only regression coverage | ABC-003, ABC-004, ABC-008, ABC-010 | DEF-028 | Playwright, Vitest | Completed-session/read-only, Previous Attempt gate, Session, Day | Saved-session/read-only route state fixture; safe navigation guards. | Needs route/state fixture | Do not mutate saved session records to create the state. |
